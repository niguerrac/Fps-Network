...
public var inhibit_autowalk:float=0.2;
...
function Awake () {
	...
	PlayerPrefs.SetString("stay","true");
}
...
//if((Input.GetKeyDown(KeyCode.JoystickButton5)||Input.GetKeyDown("z")) && autowalk==1 && Time.time > nextFire)
//{
//autowalk=0;   
...
//if (PlayerPrefs.GetString("stay")=="true")directionVector=Vector3(0,0,0);

//if((Input.GetKeyDown(KeyCode.JoystickButton5)||Input.GetKeyDown("z"))&& autowalk==0 && Time.time > nextFire)
//{
//autowalk=1;
//directionVector=Vector3(Input.GetAxis("Horizontal"), 0, Input.GetAxis("Vertical"));
//nextFire = Time.time + 0.5;
//}
